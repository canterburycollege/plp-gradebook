...
class ilp_dashboard_student_info_plugin extends ilp_dashboard_plugin {
	...
	function display()	{	
		...
		if (!empty($student))	{ 
			...
			//if (!empty($statusitem))	{
			//	if ($statusitem->passfail == 1) $userstatuscolor	=	"#FF0804"; //Red *
                        //        if ($statusitem->passfail == 2) $userstatuscolor	=	"#FF750A"; //Orange
                        //        if ($statusitem->passfail == 3) $userstatuscolor	=	"#08FF2C"; //Green
                        //        
                        switch ($statusitem->passfail) {
                        case 0:
                         $userstatuscolor	=	$userstatuscolor = "#FF750A"; //Orange"
                         break;
                        case 1:
                        $userstatuscolor	=	$userstatuscolor = "#FF0804"; //Red *
                        break;
                          case 2:
                        $userstatuscolor	=	$userstatuscolor = "#08FF2C"; //Green
                        break;
